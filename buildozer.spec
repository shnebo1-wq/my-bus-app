...
# --- კრიტიკული ცვლილება REQUIREMENTS-ში ---
# Pillow-ს ძველი ვერსია (9.5.0) უფრო სტაბილურია Buildozer-ისთვის
requirements = python3,kivy==2.3.0,kivymd==1.2.0,pillow==9.5.0,requests,urllib3,certifi

# (str) Icon and Presplash (თუ არ გაქვს ფაილები, დასვი # წინ)
...
[buildozer]
# ლოგების დონე მაქსიმალურია, რომ შეცდომა დავინახოთ
log_level = 2
warn_on_root = 1
